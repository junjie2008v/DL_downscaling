...
PRISM_TMAX  = hdf_io['PRISM_TMAX'] [...]
PRISM_TMIN  = hdf_io['PRISM_TMIN'] [...]
...
FIT_TMAX = np.concatenate((FIT_BASE, FIT_BASE_leap, FIT_BASE, FIT_BASE, FIT_BASE[0, ...][None, ...]), axis=0)
STD_BASE = temp_data[()]['FIT_STD'][...]
STD_BASE_leap = temp_data[()]['FIT_STD_leap'][...]
STD_TMAX = np.concatenate((STD_BASE, STD_BASE_leap, STD_BASE, STD_BASE, STD_BASE[0, ...][None, ...]), axis=0)

temp_data = np.load(BACKUP_dir+'TMIN_STD.npy')
FIT_BASE = temp_data[()]['FIT_MEAN'][...]
FIT_BASE_leap = temp_data[()]['FIT_MEAN_leap'][...]
FIT_TMIN = np.concatenate((FIT_BASE, FIT_BASE_leap, FIT_BASE, FIT_BASE, FIT_BASE[0, ...][None, ...]), axis=0)
STD_BASE = temp_data[()]['FIT_STD'][...]
STD_BASE_leap = temp_data[()]['FIT_STD_leap'][...]
STD_TMIN = np.concatenate((STD_BASE, STD_BASE_leap, STD_BASE, STD_BASE, STD_BASE[0, ...][None, ...]), axis=0)
...
labels = ['PRISM_TMAX', 'PRISM_TMIN', 'FIT_TMAX', 'FIT_TMIN', 'STD_TMAX', 'STD_TMIN', 'TMAX_REGRID', 'TMIN_REGRID', 
          'lon', 'lat', 'etopo', 'etopo_regrid']
data = (PRISM_TMAX, PRISM_TMIN, FIT_TMAX_interp, FIT_TMIN_interp, STD_TMAX_interp, STD_TMIN_interp, REGRID_TMAX, REGRID_TMIN, 
        lon, lat, etopo, etopo_regrid)

du.save_hdf5(data, labels, out_dir = BACKUP_dir, filename='PRISM_std_2015_2018.hdf')
