...
# overwrite flags
input_flag = [True, False, False, False, False, False] # HR target and elev
...
for sea in seasons:
    ...
    #
    model_path = temp_dir+'DAE_{}_{}_self.hdf'.format(VAR, sea)
    train_path = temp_dir+'DAE_{}_{}_self.npy'.format(VAR, sea)
