...
mlr_dir = out_dir +'MLR_T2_NCEP.hdf'
...
for VAR in VAR_list:
    ...
    MEAN = hdf_io['FIT_{}'.format(VAR)][...][-365:, ...]
    STD  = hdf_io['STD_{}'.format(VAR)][...][-365:, ...]
    REGRID_VAR = hdf_io['{}_REGRID'.format(VAR)][...][-365:, ...]
    hdf_io.close()
    T_REGRID = REGRID_VAR*STD+MEAN
    
    hdf_io = h5py.File(BACKUP_dir+'PRISM_std_clim_2015_2018.hdf', 'r')
    T_TRUE = hdf_io['PRISM_{}'.format(VAR)][365:-2, ...][-365:, ...]
    CLIM_VAR = hdf_io['{}_CLIM'.format(VAR)][365:-2, ...][-365:, ...]
    etopo = hdf_io['etopo'][...]
...
du.save_hdf5(tuple(data), label, out_dir=save_dir, filename='PRISM_PRED_NCEP_2018_clim.hdf')