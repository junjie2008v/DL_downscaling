...
for sea in seasons:
    # ---------- Generator ---------- #
    # load weights
    model_name = 'UNET-G{}_{}_{}_tune_raw'.format(N_input, VAR, sea) # UNET{}_{}_{}_tune
    ...
    # Filepath
    file_path = BATCH_dir
    trainfiles = glob(file_path+'{}_BATCH_*_TORI*{}*.npy'.format(VAR, sea)) # e.g., TMAX_BATCH_128_VORIAUG_mam30.npy
    ...
    # model names
    G_name = 'NEO_G_{}_{}_raw'.format(VAR, sea)
    D_name = 'NEO_D_{}_{}_raw'.format(VAR, sea)
    G_path = temp_dir+G_name+'.hdf'
    D_path = temp_dir+D_name+'.hdf'
    hist_path = temp_dir+'NEO_LOSS_{}_{}_raw.npy'.format(VAR, sea)
