...
for VAR in VARS:
    ...
    with h5py.File(ERA_dir + 'ERA_{}_features_US_2015_2020.hdf'.format(VAR), 'r') as hdf_io:
    ...
    du.save_hdf5(tuple_save, label_save, out_dir=ERA_dir, filename='ERA_US_{}_clean_2015_2020.hdf'.format(VAR))
