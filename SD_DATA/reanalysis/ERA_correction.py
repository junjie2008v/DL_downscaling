...
with h5py.File(ERA_dir + 'ERA_TMEAN_GAMMA_2018_2020.hdf', 'r') as hdf_io:
    lon_025 = hdf_io['lon_025'][...]
    lat_025 = hdf_io['lat_025'][...]
    era_gamma = hdf_io['era_gamma'][...]
...
for i, date in enumerate(date_list):
    ...
    gamma_interp = 0.5*du.interp2d_wraper(lon_025, lat_025, era_gamma[i, ...], lon_4km, lat_4km, method=interp_method)
...
du.save_hdf5(data_save, label_save, ERA_dir, 'ERA_TMEAN_correct_2018_2020.hdf')
