...
for sea in seasons:
    ...
    # tuned model
    model_name_tune = model_name+'_tune_raw' # save separatly
    ...
    trainfiles = glob(file_path+'{}_BATCH_*_TORI*{}*.npy'.format(VAR, sea)) # e.g., TMAX_BATCH_128_VORI_mam30.npy, 
    validfiles = glob(file_path+'{}_BATCH_*_VORI*{}*.npy'.format(VAR, sea)) # excluding "ORIAUG" pattern
    # shuffle filenames
    shuffle(trainfiles)
    shuffle(validfiles)
    # generators
