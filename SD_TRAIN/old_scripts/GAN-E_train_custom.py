...
for sea in seasons:
    ...
    G_style = mu.UNET_STYLE_NOISE(N, input_size, latent_lev, latent_size, mapping_size, pool=pool, activation=activation)
    ...
    # Filepath
    file_path = BATCH_dir
    trainfiles = glob(file_path+'TMEAN_BATCH_96_TORI_*{}*.npy'.format(sea)) # e.g., TMAX_BATCH_128_VORIAUG_mam30.npy
