...
PRISM_PCT = hdf_io['PRISM_PCT'][365:-2, ...]
CLIM_PCT = hdf_io['CLIM_PRISM_PCT'][365:-2, ...]
etopo = hdf_io['etopo'][...]
lon = hdf_io['lon'][...]
lat = hdf_io['lat'][...]
hdf_io.close()
...
du.save_hdf5(tuple(data), label, out_dir=save_dir, filename='PRISM_PRED_NCEP_PCT_2016_2018.hdf')