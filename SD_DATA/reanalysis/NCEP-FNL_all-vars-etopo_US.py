...
in the US domain. Land mask and ETOPO1 provided.
'''
...
# US subset indices identified by hand (single file test)
domain_ind = [80, 180, 0, 100]
...
for var in VARS:
    ...
    label_save = ['lon_4km', 'lat_4km', 'lon_ncep', 'lat_ncep', 
                  ...
                  'etopo_4km', 'etopo_regrid', 'land_mask']
    du.save_hdf5(data_save, label_save, NCEP_dir, 'NCEP_{}_features_2016_2020.hdf'.format(var))
