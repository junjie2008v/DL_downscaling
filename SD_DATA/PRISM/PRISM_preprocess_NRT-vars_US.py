...
Converting raw near real-time PRISM files into a single hdf
TMAX/TMIN/PCT in one file
'''
...
for var in vars:
    ...
    du.save_hdf5(tuple_save, label_save, out_dir=PRISM_dir, filename='PRISM_{}_2015_2020.hdf'.format(var))
