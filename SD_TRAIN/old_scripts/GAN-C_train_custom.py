...
layer_id = [19]
def loss_model(VAR, layer_id):
    model_path = temp_dir+'DAE_{}_jja_elev.hdf'.format(VAR) # model checkpoint
...
for sea in seasons:
    ...
    #loss_models = loss_model(VAR, layer_id)
    ...
    GAN.compile(loss=[CLOSS, keras.losses.binary_crossentropy], 
    ...
    for i in range(epochs):
        ...
        for j, name in enumerate(trainfiles):
            ...
            dummy_good = np.ones(train_size) - dummy_bad
            # import batch data
