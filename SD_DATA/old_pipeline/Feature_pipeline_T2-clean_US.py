...
# clean-up
if del_old:
    cmd = 'rm {}*PRISM-clean*npy'.format(BATCH_dir); print(cmd)
    subprocess.call(cmd, shell=True)
    cmd = 'rm {}*PRISM-clean*npy'.format(BATCH_dir+'temp_batches/'); print(cmd)
    subprocess.call(cmd, shell=True)
...
for var in vars:
    ...
    with h5py.File(PRISM_dir+'PRISM_{}_clean_2015_2020.hdf'.format(var), 'r') as hdf_io:
        for key in keys_3d:
    ...
    for i, size in enumerate(sizes):
        ...
        for sea in seasons:
            ...
            for domain in domains:
                ...
                NAME_train = '{}_BATCH_{}_T{}-PRISM-clean_{}'.format(var, size, domain, sea)
                NAME_valid = '{}_BATCH_{}_V{}-PRISM-clean_{}'.format(var, size, domain, sea)
